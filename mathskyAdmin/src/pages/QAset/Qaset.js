      ...
      <div className="singleContainer">
        ...
        <div style={{ width: '100%', display: 'flex', flexWrap: 'wrap', justifyContent: 'start', }}>
          {QAdata.map((data, index) => {
            return (
              <div style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', height: '250px', width: '28%', overflow: 'scroll', marginTop: '2%', marginLeft: '2%', borderRadius: 10, display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', position: 'relative' }} key={index} >
                {/* ------------------------------buttons div ----------------------------------- */}
                <div style={{ display: 'flex', justifyContent: 'space-between', width: '90%', alignItems: 'center', marginLeft: '5%' }}>
                  <div style={{ textAlign: 'start', }} >
                    ...
                    }} variant="outlined">chapters</Button>
                  </div>
                  <div style={{ display: 'flex' }}>
                    <div style={{ textAlign: 'start' }} >
                      ...
                      }} variant="outlined" style={{ marginTop: '3%' }}> Edit</Button>
                    </div>

                    <div style={{ textAlign: 'start', marginLeft: '5%' }} >
                      <Button onClick={() => {
 if (window.confirm('Are you sure you want to delete?')){
                       deleteQAsetApi(data._id)
                       .then((res=>{
                      ...
                      }} variant="outlined" color='error' style={{ marginTop: '3%' }}> Bin</Button>
                    </div>
                  </div>
